import { HouseFactory, clientCodeResponseInterface } from "./intefaces/component.interface";

const clientCode = ({ bedRoom, livingRoom, roomType }: HouseFactory): clientCodeResponseInterface => {
    return {
        bedroom: {
